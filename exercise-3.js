...
let input1 = { x: 20, y: 2, z: 7 }
let input2 = { x: 2, y: 1, z: 20 }
let input3 = { x: 100, y: 100, z: 100 }

// really good destructuring for objects
const xyzCalc = ({ x, y, z } ) => {
return 5 * x - 2 * y - z
};

console.log(xyzCalc(input1))
console.log(xyzCalc(input2))
console.log(xyzCalc(input3))
